...
class Reader(BaseReader, StructuredReader):
	...
	def __init__(self, filename=None, name=None, gridfile=None, standard_name_mapping={}):
		...
		self.zlevels = np.array([-5, -10,-15,-20,-25,-30,-35,-40,-50,-60,-65,-70,-75,-80,-85,-90,-95,-100,-120,-150,-175,	-250, -300, -400, -500, -600, -700, -800, -900, -1000,-1200, -1500,-1800,
		...
		if isinstance(filename, xr.Dataset):
			...
			try:
				...
				self.Dataset['mask_rho'].attrs['long_name'] = 'land_binary_mask'
				self.Dataset['mask_psi'].attrs['long_name'] = 'land_binary_mask'
				self.Dataset['mask_rho'].attrs['standard_name'] = 'land_binary_mask'
				self.Dataset['mask_psi'].attrs['standard_name'] = 'land_binary_mask'
				logger.info('renamed land binary mask')
				logger.info('declaring land_binary_mask')
	...
	def get_variables(self, requested_variables, time=None,
		...
		if 'land_binary_mask' in requested_variables:
			print("Using land_binary_mask from ROMS output")

			variables['land_binary_mask'] = 1- self.land_binary_mask[indy,indx]
